...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="dashboard.php" class="logo">
      ...
      <span class="logo-lg"><b>POS</b>INVENTORY</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <!-- Optionally, you can add icons to the links -->
          ...
          <ul class="treeview-menu">
            <li><a href="tableformat.php"><i class="fa fa-circle-o"></i> Table Format</a></li>
            <li><a href="graphformat.php"><i class="fa fa-circle-o"></i> Graph Format</a></li>
          </ul>
        </li>
